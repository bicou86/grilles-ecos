...
> [!note] 📋 Anamnèse
> - [ ] **1. Reconstituer la chute — le film de l'événement**
...
> - [ ] **3. L'ordonnance et le terrain**
> 	- [ ] Ordonnance complète, ligne par ligne — le risque culmine à l'introduction d'un médicament et à chaque augmentation de dose
> 		- [ ] Antihypertenseurs et diurétiques ; le bêtabloquant à part, il empêche le cœur d'accélérer au lever et masque les signes de l'hypoglycémie
...
> 	- [ ] Antécédents chirurgicaux, hospitalisations et maladies récentes
> 	- [ ] Allergies
...
> 	- [ ] Douleurs ailleurs : le patient désigne un point, c'est au médecin de demander les autres (poignet, épaule, coude, côtes, bassin, hanche, rachis)
> 	- [ ] Impotence fonctionnelle : peut-il mobiliser le membre, a-t-il pu se relever, a-t-il pu marcher ensuite
> 	- [ ] Symptômes neuro-vasculaires distaux : paresthésies, zone insensible, faiblesse, doigts froids — ces questions se posent avant l'examen et orientent ce qu'on cherchera
> 	- [ ] Ecchymoses disproportionnées ou d'âges différents : antithrombotique, ou tendance hémorragique (saignements de nez, des gencives, règles abondantes, après blessure mineure)
> 	- [ ] Membre dominant et retentissement sur les gestes quotidiens
> 	- [ ] Antalgie déjà prise ou reçue, et proposer une antalgie
> - [ ] **5. Évaluation gériatrique — elle décide de la suite autant que la cause**
> 	- [ ] Mobilité : périmètre de marche, aides techniques (canne, rollator), escaliers, seuils
> 	- [ ] Actes de base (BADL) : transferts, toilette et douche, habillage, aller aux toilettes, s'alimenter
> 	- [ ] Actes instrumentaux (IADL) : courses, cuisine, ménage, gestion des médicaments, finances, transports, rendez-vous
> 	- [ ] Logement : étage, ascenseur, tapis, éclairage nocturne, barres d'appui, téléalarme
> 	- [ ] Entourage : état civil, proches, aide à domicile — qui passe au domicile et à quelle fréquence ; isolement social ; profession et loisirs antérieurs
> 	- [ ] Nutrition : appétit, repas réellement pris, évolution du poids
...
> 	- [ ] TA couchée après 5 minutes, puis debout à 1 et 3 minutes (Schellong) : une baisse d'au moins 20 mmHg de systolique ou 10 mmHg de diastolique signe l'hypotension orthostatique
> 	- [ ] Fréquence cardiaque : l'absence d'accélération au lever oriente vers le bêtabloquant ou une dysautonomie ; fréquence respiratoire, saturation
> 	- [ ] Température — chez le sujet âgé, la fièvre peut manquer devant une infection
> 	- [ ] Glycémie capillaire
> 	- [ ] État général, vigilance, orientation
> - [ ] **2. Bilan lésionnel — inspection et palpation, de la tête aux pieds**
> 	- [ ] Crâne et face : plaie, hématome, enfoncement ; conjonctives, sclères, pupilles, oculomotricité
...
> 	- [ ] Motricité des quatre membres, épreuve des bras tendus
> 	- [ ] Sensibilité, dont la sensibilité vibratoire au diapason et le monofilament aux pieds (polyneuropathie)
> 	- [ ] Réflexes ostéo-tendineux et signe de Babinski
> 	- [ ] Épreuves cérébelleuses : doigt-nez, talon-genou, diadococinésie
> 	- [ ] Romberg, Unterberger
...
> 	- [ ] Abdomen : inspection, auscultation, palpation (globe vésical, douleur)
> 	- [ ] Bouche : état bucco-dentaire, hydratation des muqueuses
> 	- [ ] Acuité visuelle avec la correction habituelle, et audition
> 	- [ ] Pieds et chaussures : callosités, hallux valgus, semelles usées ou instables
> - [ ] **5. Équilibre et marche, quand l'état le permet**
> 	- [ ] Redressement depuis le lit, puis transfert lit-fauteuil : avec ou sans appui des bras, avec ou sans aide
> 	- [ ] Station debout, pieds joints, yeux ouverts puis fermés
> 	- [ ] Timed up and go : se lever d'une chaise, marcher 3 mètres, demi-tour, revenir, se rasseoir — au-delà de 12 à 14 secondes, le risque de rechute est élevé
> 	- [ ] Appui monopodal : moins de 5 secondes est pathologique
> 	- [ ] Analyse de la marche : longueur du pas, polygone de sustentation, demi-tour, marche en tandem
> 	- [ ] Tinetti sur 28 points si le temps le permet : moins de 20 signe le risque de chute
> - [ ] **6. Avant d'immobiliser : le membre traumatisé**
> 	- [ ] Perfusion distale comparée des deux côtés : pouls périphériques, temps de recoloration, gradient thermique
